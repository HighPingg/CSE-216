...
public class Homework_3 {
    ...
    public static Collection<String> capitalized(Collection<String> strings) {
        return strings.stream().filter((element) -> element.charAt(0) >= 65 && element.charAt(0) <= 65)
    ...
    public static void main(String[] args) {
        ArrayList<String> strings = new ArrayList<>(Arrays.asList("Hi", "bye", "go", "KYS", "yOURSELF"));
