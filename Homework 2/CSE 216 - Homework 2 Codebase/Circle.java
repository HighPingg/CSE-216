...
public class Circle implements TwoDShape, Positionable {
    ...
    /**
     * Sets the position of this circle to be centered at the first element in the
    ...
    /**
     * Checks whether or not a list of vertices is a valid collection of vertices
     * for the type of two-dimensional shape.
     *
     * @param centers the list of vertices to check against, where each vertex is a
     *                <code>Point</code> type. For the Circle object, this list is
     *                expected to contain only its center.
     * @return <code>true</code> if and only if <code>centers</code> is a single
     *         point, and the radius of this circle is a positive value.
     */
    @Override
