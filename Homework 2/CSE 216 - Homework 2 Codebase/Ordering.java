...
public class Ordering {
    ...
    /**
     * PLEASE READ ALL THE COMMENTS IN THIS CODE CAREFULLY BEFORE YOU START WRITING
     * YOUR OWN CODE.
     */
    public static void main(String[] args) {

        /*
         * ====== Any additional code you write to create instances or call methods,
         * must be above this line ======
         */
        // TODO: The following two lines are using the raw type. Equip them with the
        // proper parameters so that they work with the remainder of the code that
        // follows.
        ...
        /*
         * shapes.add(new Circle(...)); shapes.add(new Triangle(...)); shapes.add(new
         * Quadrilateral(...));
         * 
         * copy(new ArrayList<Circle>(), shapes); // note-1 //
         * 
         * // sorting 2d shapes according to various criteria shapes.sort(new
         * XLocationShapeComparator()); Collections.sort(shapes); // TODO: Must sort the
         * two-dimensional shapes in increasing of their area
         * 
         * // sorting 2d points according to various criteria // TODO: Implement a
         * static nested class so that uncommenting the following line works. The
         * XLocationPointComparator must sort all the points in a collection in
         * increasing order of their x-values. // points.sort(new
         * XLocationPointComparator()); Collections.sort(points); // TODO: Must sort the
         * points in increasing order of their distance from the origin
         */
         ...
         * with 'note-1' above while at the same time also working with the lines
         * commented with 'note-2', 'note-3', and 'note-4' below.
         */

        /*
         * List<Number> numbers = new ArrayList<>(); List<Double> doubles = new
         * ArrayList<>(); Set<Triangle> triangles = new HashSet<>(); Set<Quadrilateral>
         * quads = new LinkedHashSet<>();
         * 
         * copy(doubles, numbers); // note-2 // copy(quads, shapes); // note-3 //
         * copy(triangles, shapes); // note-4 //
         */

        /* ====== SECTION 3 ====== */
        /*
         * uncomment the following lines of code and fill in the "..." constructors to
         * create actual instances. You may test your code with more instances (the two
         * lines are provided just as an example that different types of shapes can be
         * added). If your implementations are correct, the code should compile and
         * print the various shapes in their human-readable string forms. Note that you
         * have to implement a certain method in the classes that implement the
         * TwoDShape interface, so that the printed values are indeed in a
         * human-readable form. These are defined as follows:
         *
         ...
         *
         * For triangles and quadrilaterals, the vertex ordering is specified in the
         * documentation of their respective getPosition methods. Each point must be
         * represented up to two decimal places. For the purpose of this assignment, you
         * may safely assume that no test input will be used in grading where a vertex
         * has more than two decimal places.
         */

        /*
         * List<TwoDShape> lst = new ArrayList<>(); lst.add(new Circle(...));
         * lst.add(new Triangle(...)); printAllAndReturnLeast(lst, new Printer());
         */
    }
